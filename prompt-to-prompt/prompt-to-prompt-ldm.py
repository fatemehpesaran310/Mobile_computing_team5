...
prompts = ["A woman with blue hair"]
controller = AttentionStore()
images, x_t = run_and_display(prompts, controller, run_baseline=False, generator=g_cpu)
show_cross_attention(controller, res=16, from_where=["up", "down"])
 
prompts = ["A painting of a squirrel eating a burger", 
           "A watercolor painting of a squirrel", 
           "A dark painting of a squirrel eating a green burger", 
           "A realistic photo of a squirrel eating a pink burger"
]
